...
The game draws on a [[2020_BeyondIssuePublics|dataset of public Danish Facebook pages]] (curated by Asger and myself before the 2018 API changes). Players are presented with a post and a comment from Facebook. They then have to guess how the commenter emoji reacted to the post. 
